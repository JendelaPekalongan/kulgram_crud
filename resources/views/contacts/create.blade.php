...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Form Input Data Kontak') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('contacts.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="hobi" type="text" class="form-control{{ $errors->has('hobi') ? ' is-invalid' : '' }}" name="hobi" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="no_hp" type="text" class="form-control{{ $errors->has('no_hp') ? ' is-invalid' : '' }}" name="no_hp" required>
                            </div>
                        </div>
